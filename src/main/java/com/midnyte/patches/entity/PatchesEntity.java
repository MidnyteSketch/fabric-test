...
public final class PatchesEntity extends PathfinderMob {
    ...
    @Override protected void registerGoals(){
        ...
        this.goalSelector.addGoal(1,new PatchesFlowerCuriosityGoal(this));
    ...
    @Override protected InteractionResult mobInteract(Player player,InteractionHand hand){
        ...
        if(isRejectedFood(stack))return InteractionResult.FAIL;return super.mobInteract(player,hand);
    }
